// Package tenant holds the tenancy core: tenants, memberships, invitations,
// per-tenant settings, the per-request RLS binding helper, and the
...
// policies expose zero rows — isolation fails closed.
