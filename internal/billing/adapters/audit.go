...
// AuditLog records privileged billing actions in the shared audit_log table. It
// implements the command layer's AuditWriter port.
...
// Record appends one audit entry inside the tenant-bound transaction. Subscribe,
// cancel, and settle are privileged actions made through a workspace session.
